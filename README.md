...
`laravel-etrade` is a Laravel client package for the E*Trade v1 API which is a rewrite of `https://github.com/kevinrider/phpetrade` using standard Laravel features and removes the PHP OAuth PECL requirement in favor of Guzzle.
